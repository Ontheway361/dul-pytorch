...
class ResidualBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, stride = 1):
        ...
        self.blocklayers = nn.Sequential(nn.BatchNorm2d(in_channel),
...
class AttentionModule_stage2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(28, 28), size2=(14, 14)):
        ...
        self.trunk_branches = nn.Sequential(ResidualBlock(in_channels, out_channels),
...
class AttentionModule_stage3(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(14, 14)):
        ...
        self.mpool1 = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.softmax1_blocks = nn.Sequential(ResidualBlock(in_channels, out_channels),
                                             ResidualBlock(in_channels, out_channels))
